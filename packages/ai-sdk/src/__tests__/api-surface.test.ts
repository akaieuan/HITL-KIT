...
/**
 * Public runtime export-name snapshot for @hitl-kit/ai-sdk.
 *
 ...
 * snapshotted separately in api-surface/ai-sdk.d.ts via `pnpm api:check`.
 */
describe("@hitl-kit/ai-sdk public API", () => {
